...
# Output path : ./signals.json (à côté du script) — marchera qu'on l'exécute
# en local (/home/user/dashboard/signals.json) ou via GitHub Actions
# ($GITHUB_WORKSPACE/signals-dashboard/signals.json). Pour forcer un autre
# chemin, définir la variable d'environnement SIGNALS_OUTPUT_PATH.
_SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))
OUTPUT_PATH = os.environ.get("SIGNALS_OUTPUT_PATH",
                            os.path.join(_SCRIPT_DIR, "signals.json"))
